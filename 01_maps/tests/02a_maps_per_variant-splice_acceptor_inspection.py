...
def main():
    ...
    ht = hl.read_table('gs://janucik-dataproc-stage/01_maps/data_full_ht_31_Oct_22_v2/02a_f_ht_final.ht')

    ht.describe()

    ht_splice_acceptor = ht.filter(ht.most_severe_consequence == 'splice_acceptor_variant')
    ht_splice_acceptor_sampled = ht_splice_acceptor.sample(0.5)
    ht_splice_acceptor_sampled_2 = ht_splice_acceptor_sampled.select(lof = ht_splice_acceptor_sampled.vep.transcript_consequences.lof, most_severe_consequence = ht_splice_acceptor_sampled.most_severe_consequence)
    ht_splice_acceptor_sampled_2.describe()
