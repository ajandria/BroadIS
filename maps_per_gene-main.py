...
def main():
    ...
    ht = ht.checkpoint('gs://janucik-dataproc-stage/01_maps/data_full_ht_02_Nov_22_v4/ht_filtered.ht')
    ...
    maps_table.export('gs://janucik-dataproc-stage/01_maps/data_full_ht_07_Nov_22_v4/02a_f_maps_table.csv', delimiter=',')
    ht_syn_ps.export('gs://janucik-dataproc-stage/01_maps/data_full_ht_07_Nov_22_v4/ht_syn_ps.csv', delimiter=',')
