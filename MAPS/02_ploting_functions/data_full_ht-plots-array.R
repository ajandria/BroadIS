...
# Setup -------------------------------------------------------------------
maps_table <- read_csv("01_maps/gc_out/02b_maps_per_variant_array-main_17_Nov_22_v2/02a_f_maps_table.csv")
maps_table <- maps_table[order(maps_table$lof_csq_collapsed), ]

ht_syn_ps <- read_csv("01_maps/gc_out/02b_maps_per_variant_array-main_17_Nov_22_v2/ht_syn_ps.csv")
